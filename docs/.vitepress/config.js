...
export default {
  ...
  themeConfig: {
    ...
    footer: {
      message: "",
      copyright: "Copyright © 2023-present beiChen",
    },
    // 设置编辑页面链接
    editLink: {
